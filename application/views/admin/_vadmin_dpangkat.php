          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="<?php echo base_url()?>admin/Cpangkat" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pangkat</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> <i class="nav-icon far fa-circle nav-icon"></i> Data Pangkat</h1>

            <a href="<?php echo base_url()?>admin/exportpdf/Cexport_pdf_dpangkat/dpangkat_all"><i class="fa fa-download"></i> Cetak Data</a>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"> <i class="nav-icon fas fa-desktop"></i> Data Master</a></li>
              <li class="breadcrumb-item active"> <i class="nav-icon far fa-circle nav-icon"></i> Data Pangkat</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <span class="badge bg-warning">  <a href="#" data-toggle="modal" data-target="#edit-data<?php echo $kd_pangkat;?>"><i class="fa fa-edit"></i> Ubah</a></span>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="<?php echo base_url()?>admin/Cpangkat/tambah_pangkat" onsubmit="return validasi_tambah(this)">


<script type="text/javascript">
  function validasi_tambah(form){

      if (form.kd_pangkat.value == ""){
    alert("Kode Pangkat masih kosong!");
    form.kd_pangkat.focus();
    return (false);
  }
  ...
  return (true);
                        ...
                        <div class="modal-body">
                          ...
                          <div class="alert alert-warning alert-dismissible">
                            ...
                            <p>Isilah form pangkat anda dengan lengkap, terutama yang bertanda (*)</p>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" placeholder="Kode Pangkat" style="width: 200px;" name="kd_pangkat">
...
<?php 
  ...
  <!-- =====================MODAL EDIT DATA========================= -->    
<div class="modal fade" id="edit-data<?php echo $kd_pangkat;?>" data-backdrop="static">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><i class="fa fa-edit"></i> Ubah Data Pangkat</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>

                         <form role="form" name="myform" method="post" action="<?php echo base_url()?>admin/Cpangkat/edit_pangkat" onsubmit="return validasi_edit(this)">
...
<script type="text/javascript">
  ...
  return (true);
                        ...
                        <div class="form-group">
                          <label>Kode Pangkat*</label>
                          <input class="form-control" type="text" placeholder="Kode Pangkat" style="width: 200px;" name="kd_pangkat" readonly="" value="<?php echo $kd_pangkat;?>">
