        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url()?>pengemudi/Cdpengemudi" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dpengemudi/dpengemudi_all"><i class="fa fa-download"></i> Cetak Data</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <span class="badge bg-danger"><a href="<?php echo base_url()?>pengemudi/Cdpengemudi/hapus_pengemudi/<?php echo $nip_pengemudi; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini?')" ><i class="fa fa-trash"> Hapus</i></a></span>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdpengemudi/tambah_pengemudi" onsubmit="return validasi_tambah(this)" enctype="multipart/form-data">
                ...
                <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="alert alert-warning alert-dismissible">
                            ...
                            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dpengemudi/dpengemudi_by_id/<?php echo $nip_pengemudi ?>" class="btn btn-success"><i class="fa fa-download"></i> Cetak Pengemudi</a>
                        </div>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdpengemudi/edit_pengemudi" onsubmit="return validasi_edit(this)" enctype="multipart/form-data">
