     <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>pengemudi/Cdservice" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dservice/dservice_all"><i class="fa fa-download"></i> Cetak Data</a>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="card card-primary card-outline">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($bukti != NULL): ?>
                    <img src="<?php echo base_url(); ?>assets/bukti/<?php echo $bukti; ?>" style="width: 80px; height: 80px;" class="img-circle img-thumbnail"><br>
                    <?php else: ?>
                         <img src="<?php echo base_url()?>assets/bukti/noimage.jpg" style="width: 80px; height: 80px;" class="img-circle img-thumbnail"><br>
                        <?php endif; ?>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdservice/tambah_service" onsubmit="return validasi_tambah(this)" enctype="multipart/form-data">
                ...
                <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="alert alert-warning alert-dismissible">
                            ...
                            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dservice/dservice_by_id/<?php echo $id_service ?>" class="btn btn-success"><i class="fa fa-download"></i> Cetak Service Kendaraan</a>
                        </div>



                        <center>
                        <?php if ($id_jenis_kendaraan == '1'): ?>
                        <img src="<?php echo base_url()?>assets/img/car.png" style="width: 180px; height: 180px;" class="img-circle img-thumbnail"><br>
                        <?php elseif ($id_jenis_kendaraan == '2'): ?>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                         ...
                         <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdservice/edit_service" onsubmit="return validasi_edit(this)" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  return (true);
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Upload Bukti
                      <a href="#" class="btn btn-xs btn-default">Hapus Bukti</a></label>
