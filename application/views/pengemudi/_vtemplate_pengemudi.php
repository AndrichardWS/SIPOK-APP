  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin - <?php echo $_SESSION['username']; ?></a>
...
<script>
  ...
  $(document).ready(function(){
        $('#jenis_kendaraan').change(function(){
            ...
            $.ajax({
                url : "<?php echo base_url('pengemudi/Cdservice/get_jenis_kendaraan')?>",
                method : "POST",
                ...
                success: function(data){
                    ...
                    for(i=0; i<data.length; i++){
                        html += '<option>'+'['+data[i].no_polisi+']'+' '+'-'+' '+data[i].nama_kendaraan+'</option>';
                    }
                    $('.no_polisi').html(html);
