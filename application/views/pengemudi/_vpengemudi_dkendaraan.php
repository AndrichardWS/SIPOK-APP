        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url()?>pengemudi/Cdkendaraan" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Kendaraan</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dkendaraan/dkendaraan_all"><i class="fa fa-download"></i> Cetak Data</a>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <table id="example4" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <span class="badge bg-danger"><a href="<?php echo base_url()?>pengemudi/Cdkendaraan/hapus_kendaraan/<?php echo $no_polisi; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini?')" ><i class="fa fa-trash"> Hapus</i></a></span>
                  </td>
                </tr>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                        ...
                        <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdkendaraan/tambah_kendaraan" onsubmit="return validasi_tambah(this)" enctype="multipart/form-data">
                ...
                <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="alert alert-warning alert-dismissible">
                            ...
                            <a href="<?php echo base_url()?>pengemudi/exportpdf/Cexport_pdf_dkendaraan/dkendaraan_by_id/<?php echo $no_polisi ?>" class="btn btn-success"><i class="fa fa-download"></i> Cetak Kendaraan</a>
                        </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Jenis Ken." disabled="" value="<?php echo $jenis_kendaraan;?>" style="width: 400px;">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nm. Kendaraan" disabled="" value="<?php echo $nama_kendaraan;?>" style="width: 200px;">
                    </div>
                  </div>
            ...
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                         ...
                         <form role="form" name="myform" method="post" action="<?php echo base_url()?>pengemudi/Cdkendaraan/edit_kendaraan" onsubmit="return validasi_edit(this)" enctype="multipart/form-data">
