...
class Cdpengemudi extends SessionPengemudi_Controller {


	public function index(){

		$x['data']=$this->Mpengemudi->tampil_pengemudi();
		$this->template->load('pengemudi/_vtemplate_pengemudi','pengemudi/_vpengemudi_dpengemudi', $x);
	}
	...
	public function tambah_pengemudi(){
		...
		redirect('pengemudi/Cdpengemudi');
	}
